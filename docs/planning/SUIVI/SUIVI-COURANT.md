...
**Reports / à garder en tête** : lancement emploi (ancre semaine, **mardi 30 matin**), skill `job-tracker` (atelier au retour), US18 brainstorm produit, US05 delete account, polish NtF `_field` DRY + warning bullet régression depuis Follow #125, PR Dependabot `tailwindcss-rails 4.6.0` ouverte.
