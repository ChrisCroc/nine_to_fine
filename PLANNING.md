...
- **Samedi 30 mai** : journée chargée — voir détail dans le tableau "Sem 22" (5 chantiers : rattrapage Odin 17/18/19, exos sandbox polymorphic + piège default, Tailwind layouts, routine `/end-of-day` reportée de vendredi, ménage dotfiles).
